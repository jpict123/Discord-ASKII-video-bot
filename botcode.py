...
CLIP_FRAMES = 0  ##found by running the first program and finding number of created images

CLIP_LENGTH = 0   ##approximately the length of the video in seconds, works best if you add a few extra for any approximations
...
async def on_message(message):
    ...
    if message.content.startswith(' '): #The command which will start the picture
